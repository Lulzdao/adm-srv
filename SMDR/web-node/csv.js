...
//
// Рядом лежит xlsx.js — второй формат выгрузки. CSV остаётся потому, что
// пишется настоящим потоком, строка за строкой: книгу .xlsx нельзя отдать,
// пока не сжата последняя строка, а CSV на весь журнал за пять лет уедет с
// постоянным расходом памяти.
//
